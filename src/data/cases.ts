...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    client: "NETpc",
    subtitle: "Data Strategy & Marketing Analytics Department",
    subtitleEs: "Estrategia de Datos y Departamento de Análisis de Marketing",
    sector: "Tech / Tourism & Trade",
    sectorEs: "Tecnología / Turismo y Comercio",
    ...
    challengeEs:
      "Una gran empresa holding uruguaya con operaciones en turismo, comercio de exportación y retail carecía de infraestructura de datos unificada y capacidades de análisis. Cada vertical operaba independientemente con datos aislados. La gerencia necesitaba una vista integral del desempeño empresarial entre divisiones, información de clientes para marketing dirigido y toma de decisiones basada en datos a nivel ejecutivo.",
    approach:
    ...
    approachEs:
      "Construimos un almacén de datos centralizado agregando datos de sistemas de reservas de turismo, plataformas de comercio electrónico y sistemas de gestión de comercio de exportación. Implementamos pipelines ETL usando Apache Airflow para integración y transformación de datos automatizada. Creamos capa semántica con métricas de negocios y dimensiones para análisis fácil. Desarrollamos paneles ejecutivos en Tableau mostrando KPIs en todas las unidades de negocio. Construimos motor de análisis de clientes para segmentación y marketing predictivo. Establecimos marco de gobernanza de datos y capacitamos al equipo de análisis.",
    deliverables: [
      "Centralized data warehouse (Snowflake)",
      "ETL pipeline infrastructure (Apache Airflow)",
      "Business intelligence semantic layer",
      "Executive dashboard suite (Tableau)",
      "Customer analytics and segmentation models",
      "Predictive marketing models",
      "Data governance and quality framework",
      "Analytics team training and support",
    ],
    deliverablesEs: [
      "Almacén de datos centralizado (Snowflake)",
      "Infraestructura de pipeline ETL (Apache Airflow)",
      "Capa semántica de inteligencia empresarial",
      "Suite de paneles ejecutivos (Tableau)",
      "Análisis de clientes y modelos de segmentación",
      "Modelos de marketing predictivo",
      "Marco de gobernanza de datos y calidad",
      "Capacitación y soporte del equipo de análisis",
    ],
    techStack: [
      "Snowflake",
      "Apache Airflow",
    ...
    impactEs:
      "La integración del almacén de datos proporcionó visibilidad empresarial unificada en 3 divisiones principales por primera vez. Los paneles ejecutivos redujeron el tiempo de informes de semanas a minutos. Los modelos de segmentación de clientes aumentaron la efectividad de campañas de marketing en 45%, mejorando el ROI de 2.5x a 4.2x. Los modelos predictivos identificaron segmentos de clientes de alto valor, permitiendo campañas de adquisición dirigidas que redujeron el costo de adquisición de clientes en 30%. Las decisiones impulsadas por datos anuales aumentaron los ingresos en $12M.",
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&q=80",
    imageAlt: "Business intelligence and data analytics dashboard",
    imageAltEs: "Panel de inteligencia empresarial y análisis de datos",
    color: "#F59E0B",
    metrics: [
      { value: "$12M", label: "Revenue Increase", labelEs: "Aumento de Ingresos" },
      { value: "4.2x", label: "Marketing ROI", labelEs: "ROI de Marketing" },
      { value: "30%", label: "Acquisition Cost Reduced", labelEs: "Reducción Costo Adquisición" },
    ],
  },
];
