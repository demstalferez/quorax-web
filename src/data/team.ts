...
export const collaborators: TeamMember[] = [
  {
    ...
    bio: 'AI Developer based in Spain with a foundation in Data Science and Cloud/Data Engineering. Builds production-grade, cloud-native AI systems — from RAG pipelines and vector search to full-stack web applications.',
    bioEs: 'Desarrollador de IA con base en España, especializado en Data Science e Ingeniería Cloud/Data. Construye sistemas de IA cloud-native de nivel producción — desde pipelines RAG y búsqueda vectorial hasta aplicaciones web full-stack.',
