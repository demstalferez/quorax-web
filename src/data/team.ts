...
export const collaborators: TeamMember[] = [
  {
    ...
    bio: 'Founder of Quorax LLC, New York. Specialized in Data Science and Cloud Engineering. Builds production-grade AI systems — from RAG pipelines and vector search to full-stack web applications.',
    bioEs: 'Fundador de Quorax LLC, Nueva York. Especializado en Data Science e Ingeniería Cloud. Construye sistemas de IA de nivel producción — desde pipelines RAG y búsqueda vectorial hasta aplicaciones web full-stack.',
  ...
  },
  {
    ...
    bio: 'ServiceNow Senior Consultant at DXC Technology with 8+ years delivering ITSM solutions globally. MSc in Cybersecurity, specialized in GenAI for IT Ops, MLOps and Azure ML. AI Instructor at Upgrade Hub.',
    bioEs: 'Consultor Senior de ServiceNow en DXC Technology con más de 8 años implantando soluciones ITSM a nivel global. Máster en Ciberseguridad, especializado en GenAI para IT Ops, MLOps y Azure ML. Profesor de IA en Upgrade Hub.',
  ...
  },
  {
    ...
    role: 'Digital Transformation & Data Analytics',
    roleEs: 'Transformación Digital y Análisis de Datos',
    bio: 'CDO at Accem and Data Analytics Teacher at Upgrade Hub. 8+ years leading digital strategy, data governance, and cloud migration in humanitarian organizations including the Spanish Red Cross.',
    bioEs: 'CDO en Accem y Profesora de Data Analytics en Upgrade Hub. Más de 8 años liderando estrategia digital, gobernanza de datos y migración cloud en organizaciones humanitarias, incluyendo Cruz Roja Española.',
